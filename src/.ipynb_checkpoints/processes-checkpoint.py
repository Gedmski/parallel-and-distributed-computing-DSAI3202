...
def train_and_evaluate(n_estimators, max_features, max_depth, best_rmse, best_mape, best_model, best_parameters):
    ...
    for n in n_estimators_range:
        for f in max_features_range:
            for d in max_depth_range:
                p = multiprocessing.Process(target=train_and_evaluate, args=(n, f, d, best_rmse, best_mape, best_model, best_parameters))
                processes.append(p)
                p.start()
